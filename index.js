...
const token = '8907944426:AAEyvzbUHW3avJSRCttknvBNQh_HZ1jpOWc'; 
...
bot.onText(/\/start/, (msg) => {
    bot.sendMessage(msg.chat.id, "Anonim chatga xush kelibsiz! /search tugmasini bosing va suhbatdosh qidiring.");
});
